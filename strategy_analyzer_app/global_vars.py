...
table_rate = '2_4_Flash'

offline_wizard_for_analyze_dir = 'resources/6_gto_solutions'
tmp_player_name_directory = 'resources/5_tmp_data/1_play'
player_name_directory = 'resources/2_playerdata/name_image/1_play'
id_mapping_csv_link = 'resources/2_playerdata/IDs/id_mapping.csv'
unique_id_dir = 'resources/2_playerdata/IDs/2_uniqe'

all_logs = [] # postflopのwizardを保存するときに使う
...
# =============================
# postflopのlogをゲーム終了後保存する
# =============================
proceed_postflop = False # postflopのwizardを使うときTrueになる
pre_postflop_path = None # postflopに進むためのpathを作成したとき入れられる
quit_save_log = False # logの保存をすぐに終了したいときTrueにする　<- リセットするタイミング重要
running_save_log = False # logの保存が行われている間はTrueになる
pre_stradata_path = '' # これからlogsaveするstradataのplayで作成されたpath。これを見て、他プレイヤーのハンドが見えているか確認する

# =============================
# 解析データの統計を取る時の変数
# =============================
trust_diff_pot_rate = 25 # gtoと実際のpot額の差が25%以下は信頼できるデータとする
strong_EQ = 80 # 強いハンドと判断するEQのしきい値
weak_EQ = 40 # 強いハンドと認めるEQのしきい値

# =============================
# その他変数
# =============================

all_path_dict = {} # main でデータが追加される。その後、ほかでここを経由して参照される
...
action_list = ('Fold', 'Check', 'Call', 'Raise', 'Bet', 'Allin')
...
analyze_StackSize_list = (100, 75, 50)
...
# telegramでメッセージを送信する
# =============================
TOKEN = '' # BotFatherで取得したTOKEN
CHAT_ID = '' # getUpdatesで取得したチャットID
